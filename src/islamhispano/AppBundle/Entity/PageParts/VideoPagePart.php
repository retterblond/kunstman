...
/**
 * @ORM\Entity
 * @ORM\Table(name="islamhispano_appbundle_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "islamhispanoAppBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \islamhispano\AppBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
