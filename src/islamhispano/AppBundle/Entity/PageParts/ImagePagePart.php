 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="islamhispano_appbundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'islamhispanoAppBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \islamhispano\AppBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \islamhispano\AppBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
