 ...
 * HeaderPagePart
 *
 * @ORM\Table(name="islamhispano_appbundle_header_page_parts")
 * @ORM\Entity
 */
class HeaderPagePart extends AbstractPagePart
{
    ...
    {
	return 'islamhispanoAppBundle:PageParts:HeaderPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \islamhispano\AppBundle\Form\PageParts\HeaderPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \islamhispano\AppBundle\Form\PageParts\HeaderPagePartAdminType();
    }
}
